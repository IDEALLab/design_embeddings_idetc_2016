...
def process_image(imfile, im_save_path, num_control_points):
    ...
    bspline,u0,x_plot = fit_bspline(x, y, degree=2, num_control_points = num_control_points)
    ...
    ax1 = plt.gca()
    ax1.imshow(im,'gray',extent=[-xmid,img_w-xmid,img_h-offset,-offset])
    ...
    ax1.set_ylim([-offset,img_h-offset])
    ax1.set_xlim([-xmid,img_w-xmid])
...
if __name__ == "__main__":
    ...
    save_dir1 = results_dir + 'n_control_points = ' + str(n_control_points) + '/'
    ...
    for image_path in image_paths:
        ...
        try:
            process_image(image_path, image_save_path, n_control_points)
